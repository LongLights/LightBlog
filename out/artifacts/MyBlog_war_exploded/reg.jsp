    ...
    <div id="login_wrap">
        <div id="login"><!-- 登录注册切换动画 -->
            <div id="status">
                ...
                <i style="right: 0">up</i>
            </div>
            <span>
                    <form action="UC?fromPage=reg" method="post">
                        <p class="form"><input type="text" id="user" placeholder="username" value="${username}" name="username"></p>
                        <p class="form"><input type="password" id="passwd" placeholder="password" value="${password}" name="password"></p>
                        <p class="form"><input type="password" id="confirm-passwd" placeholder="confirm password" name="confirmed"></p>
                        <p class="form"><input type="text" id="email" placeholder="Email Address" name="email"></p>
                        <input type="submit" value="Log in" class="btn" style="margin-right: 20px;" name="submit_button">
                        <input type="submit" value="Sign up" class="btn" id="btn" name="submit_button">
